...
class Lista {
   ...
   public void mostrar( ){
      ...
      for(int i = n-1; i > (n-11) ; i--){
        //br = MyIO.println( array[i].getDataNascimento( ));
	//MyIO.println(br );
	array[i].imprimir();
      }//end for
  ...
  public void swap(int i, int j) {
   ...
   public void constroi(int tamHeap){
      ...
      for( int i = tamHeap  ; i > 1 && array[ i ].getDataNascimento().isBefore( array[i/2].getDataNascimento( ) ); i /= 2){
   ...
   public void reconstroi(int tamHeap){
      ...
      while(i <= (tamHeap/2)){
     	 br1 = array[ 2*i ].getDataNascimento( );
	 br2 = array[2*i+1].getDataNascimento( );
         
	 if ( br1.isBefore( br2 ) || 2*i == tamHeap){
            filho = 2*i;
         } else {
            filho = 2*i + 1;
         }//end else
	 ...
	 br2 = array[filho].getDataNascimento();
