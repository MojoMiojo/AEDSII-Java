...
class Pilha {
   ...
   public void mostrar (){
      ...
      Presidente [] array = new Presidente [30];
      
      for(Presidente i = topo; i != null; i = i.prox){
	       n++;
	       array[saidas] = i.elemento;
	       saidas++;
      }//end for
...
//TAD_Dinamica-----------------------------------
  ...
  public Presidente elemento, prox;

  public Presidente( Presidente elemento ){
    this.elemento = elemento;
    this.prox = null;
  }//end construtor dinamico
...
//-----------------------------------------------
  ...
  public Presidente(LocalDateTime dataNascimento, LocalDateTime inicioMandato, LocalDateTime fimMandato,
      ...
      String antecessor, String sucessor, String vice, String pagina, long paginaTam, Presidente prox) {
