...
class Lista {
   ...
   public void inserirFim(Presidente x) throws Exception {
	...
	ultimo = tmp;
	n++;
	//MyIO.println("inserirFim1()");
      }else{
      	//MyIO.println("inserirFim()");
      	tmp.ant = ultimo;
      	ultimo.prox = tmp;
      	ultimo = tmp;
      	n++;
    ...
    * @return resp int elemento a ser removido.
	   ...
	   public Presidente removerInicio( ) throws Exception {
		//MyIO.println("removerInicio()");
		 ...
		 throw new Exception("Erro ao remover! (vazia)");
	      ...
	      primeiro.prox.prox.ant = primeiro;
	   ...
	   public Presidente removerFim( ) throws Exception {
		...
		ultimo = j;
		j  = ultimo.prox = ultimo.prox.ant = null;	
		n--;
	   ...
	   public void quicksort( Presidente st, Presidente nd )throws Exception{
	    	
		LocalDateTime pivo = st.elemento.getInicioMandato();
		
		Presidente i = st, j = nd;

		//Quicksort
		while( i.ant != j.prox && i != j.prox ){
	    ...
	    if ( st.ant != j && j != st ) quicksort( st, j  );
	    if ( nd.prox!= i && i != nd ) quicksort( i , nd );
	    }//end quicksort( );

	    public void swap ( Presidente i, Presidente j )throws Exception{
	   ...
	   public void mostrar( ){
	      ...
	      for(Presidente i = primeiro.prox; 
		  i != null; i = i.prox){
		...
		/*
	      //mostrarTesteAnt
	      for( Presidente i = ultimo; i.ant != null; i = i.ant ){
		  i.elemento.imprimir( );
	      }*/
	...
	public class Presidente{
	  public Presidente elemento, prox, ant;
	...
	//end sets------------------------------------------------------
	  ...
	  public static void main ( String [] args )throws Exception{
	    ...
	    Arq log = new Arq( );
	      log.openWrite ("608507_quicksort2.txt");
