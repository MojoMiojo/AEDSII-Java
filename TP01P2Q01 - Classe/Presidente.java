...
//end sets------------------------------------------------------
  ...
  public static void main ( String [] args ){
    ...
    Presidente[] presidente = new Presidente[ 40 ];
    int i = 0, n = 0;

    String input = MyIO.readLine( );

    while( !input.equals("FIM ")){	    
      presidente[i] = ler( input );
      input = MyIO.readLine( );
      i++;
    }//end while
