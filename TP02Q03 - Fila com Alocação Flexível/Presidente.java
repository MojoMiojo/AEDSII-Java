...
class Fila {
   ...
   Presidente primeiro; // Remove do indice "primeiro".
   Presidente ultimo; // Insere no indice "ultimo".
   int n;
   /**
    ...
    */
   public double retirarMedia (){
      double soma=0,cont=0;
      Presidente j = primeiro.prox;
      for(int i = 0; i < n; i++){
    	 soma += j.elemento.getIdade( );
       	 j = j.prox;
	 cont++;
      }
      return (soma/cont);
...
public class Presidente{
  ...
  public Presidente( Presidente x ){
    this.elemento = x;
    this.prox = null;
  }
