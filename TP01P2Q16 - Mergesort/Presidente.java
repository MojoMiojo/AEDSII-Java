...
class Lista {
  ...
  public void mergeSort(Presidente[] a, int n){
      ...
      int mid = n / 2;
      Presidente[] l = new Presidente[mid];
      Presidente[] r = new Presidente[n - mid];
  ...
  public void merge(
    Presidente[] a, Presidente[] l, Presidente[] r, int left, int right) {
  
    int i = 0, j = 0, k = 0;
    while (i < left && j < right) { comp++;
...
//end sets------------------------------------------------------
  ...
  public static void main ( String [] args )throws Exception{
    ...
    Arq log = new Arq( );
      log.openWrite ("608507_mergesort.txt");
